...
export function DashboardPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="sticky top-0 z-10 bg-gray-50 -mx-4 md:-mx-8 px-4 md:px-8 pt-4 md:pt-8 pb-4 space-y-4">
        ...
        <div className="flex gap-2 bg-slate-100 p-1.5 rounded-2xl min-w-0 overflow-x-auto scrollbar-green">
          {TABS.map((tab) => (
            <button
              ...
              className={`flex items-center justify-center gap-2 px-4 py-3 rounded-xl font-bold text-sm transition-all cursor-pointer whitespace-nowrap shrink-0 ${activeTab === tab
