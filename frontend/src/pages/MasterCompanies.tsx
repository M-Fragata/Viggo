        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex gap-2">
            <select
              ...
              className="px-4 py-2.5 bg-white dark:bg-[#121212] border border-slate-200 dark:border-white/10 rounded-xl text-slate-800 dark:text-white focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 dark:focus:ring-emerald-500/20 outline-none transition-colors cursor-pointer"
            >
