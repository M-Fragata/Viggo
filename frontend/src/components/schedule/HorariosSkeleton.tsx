      ...
      {Array.from({ length: 3 }).map((_, i) => (
        ...
        >
          <div className="space-y-2 flex-1 min-w-0">
            <div className="h-5 w-48 max-w-full bg-slate-200 dark:bg-white/10 rounded-lg shimmer" />
            <div className="h-4 w-72 max-w-full bg-slate-200 dark:bg-white/10 rounded shimmer" />
            <div className="h-3 w-60 max-w-full bg-slate-200 dark:bg-white/10 rounded shimmer" />
          </div>
