  ...
  return (
    <div className="bg-white dark:bg-[#111113] border border-slate-200 dark:border-white/10 rounded-3xl shadow-sm p-6 sm:p-7 space-y-6 transition-colors">
      ...
      <div className="space-y-4 pt-2">
        ...
        {loading ? (
          <div className="border border-slate-200 dark:border-white/10 rounded-2xl overflow-hidden animate-pulse">
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse text-xs">
                <thead>
                  <tr className="border-b border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/[0.02]">
                    <th className="py-3 px-4"><div className="h-4 w-24 bg-slate-200 dark:bg-white/10 rounded shimmer" /></th>
                    <th className="py-3 px-4"><div className="h-4 w-32 bg-slate-200 dark:bg-white/10 rounded shimmer" /></th>
                    <th className="py-3 px-4"><div className="h-4 w-24 bg-slate-200 dark:bg-white/10 rounded shimmer" /></th>
                    <th className="py-3 px-4"><div className="h-4 w-20 bg-slate-200 dark:bg-white/10 rounded shimmer" /></th>
                    <th className="py-3 px-4 text-right"><div className="h-4 w-16 bg-slate-200 dark:bg-white/10 rounded shimmer ml-auto" /></th>
                  </tr>
                </thead>
                  ...
                  {Array.from({ length: 5 }).map((_, i) => (
                    <tr key={i}>
                      ...
                      <td className="py-3.5 px-4">
                        <div className="h-6 w-28 bg-slate-200 dark:bg-white/10 rounded-full shimmer" />
                      </td>
                      <td className="py-3.5 px-4">
                      ...
                      <td className="py-3.5 px-4 text-right">
                        <div className="h-7 w-20 bg-slate-200 dark:bg-white/10 rounded-lg shimmer ml-auto" />
                      </td>
                    </tr>
                  ))}
                </tbody>
