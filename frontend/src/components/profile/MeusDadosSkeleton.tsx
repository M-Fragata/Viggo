  ...
  return (
    <div className="w-full space-y-6 min-w-0">
      ...
      <div className="bg-white dark:bg-[#111113] p-4 sm:p-6 rounded-3xl border border-slate-200 dark:border-white/10 shadow-sm flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="h-10 w-44 max-w-full bg-slate-200 dark:bg-white/10 rounded-xl shimmer" />
      </div>

      {/* Section 1: Dados Pessoais */}
      <div className="bg-white dark:bg-[#111113] border border-slate-200 dark:border-white/10 rounded-3xl shadow-sm p-4 sm:p-6 space-y-6">
