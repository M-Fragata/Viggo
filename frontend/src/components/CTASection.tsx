      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-8 text-center">
        ...
        <div ref={buttonRef} className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 opacity-0">
          ...
          <a
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 rounded-full border border-white/15 bg-white/[0.04] backdrop-blur-md px-7 py-3.5 text-sm font-medium text-on-dark hover:bg-white/[0.08] hover:border-brand-green/50 hover:text-brand-green transition-all"
          >
