...
export function HeroContent({ startAnimation = true }: HeroContentProps) {
  ...
  return (
    <div className="text-center max-w-3xl flex flex-col items-center gap-5">
      <h1 className="text-5xl sm:text-6xl lg:text-7xl font-semibold tracking-tight text-slate-900 dark:text-on-dark leading-[1.1] opacity-0">
      ...
      <p
        ref={paragraphRef}
        className="mt-6 text-lg leading-relaxed text-slate-700 dark:text-on-dark opacity-0"
      >
