...
export function AppShowcase() {
  ...
  const autoGeneratedPassword = `${firstName.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "")}@fragata`;

  return (
    <section ref={sectionRef} id="plataforma-tour" className="py-20 lg:py-28 bg-slate-50 dark:bg-black relative overflow-hidden border-t border-slate-200 dark:border-white/5 transition-colors duration-200">
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            Conheça o Ponto Fragata por dentro: <span className="text-brand-green">intuitivo, ágil e em modo claro ou escuro</span>
          </h2>
          <p
            ref={paragraphRef}
                        ...
                        <span
                          className={`text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full ${
                            isActive
                              ...
                              : "bg-slate-100 dark:bg-white/5 text-slate-500 dark:text-on-dark-muted"
                          }`}
                        >
                          {tab.badge}
                        </span>
          ...
          <div ref={windowRef} className="lg:order-2 lg:col-span-8 opacity-0">
            <div className={`rounded-3xl border transition-colors duration-300 shadow-2xl overflow-hidden relative ${
              ...
              <div className={`flex items-center justify-between px-5 py-3.5 border-b transition-colors ${
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className={`hidden sm:flex items-center gap-1.5 ml-4 px-3 py-1 rounded-xl border text-[11px] font-mono transition-colors ${
                    ...
                    <span>pontofragata.com.br{activeTabItem.route}</span>
                  </div>
                </div>
                      ...
                      <div className={`flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 rounded-2xl border transition-colors ${
                        ...
                        <div>
                          ...
                          <div className={`text-base font-bold ${isDark ? "text-white" : "text-slate-900"}`}>
                            Fragata Soluções Digitais LTDA
                          </div>
                        </div>
              ...
              <div className={`px-5 py-3 border-t flex flex-col sm:flex-row items-center justify-between gap-2 text-xs transition-colors ${
                ...
                <div className="flex items-center gap-2">
                  <span className="font-medium">© {new Date().getFullYear()} Ponto Fragata. Todos os direitos reservados.</span>
                </div>
