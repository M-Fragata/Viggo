export function PlanoSkeleton() {
  return (
    <div className="w-full space-y-6 min-w-0">
      ...
      <div className="bg-white dark:bg-[#111113] border border-slate-200 dark:border-white/10 rounded-3xl shadow-sm p-4 sm:p-6 space-y-4">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="space-y-2">
              <div className="h-5 w-40 max-w-full bg-slate-200 dark:bg-white/10 rounded shimmer" />
              <div className="h-4 w-52 max-w-full bg-slate-200 dark:bg-white/10 rounded shimmer" />
            </div>
          </div>
          <div className="h-11 w-36 max-w-full bg-slate-200 dark:bg-white/10 rounded-xl shimmer" />
        </div>
      </div>

      {/* Details & Usage Skeleton */}
      <div className="bg-white dark:bg-[#111113] border border-slate-200 dark:border-white/10 rounded-3xl shadow-sm p-4 sm:p-6 space-y-4">
        <div className="h-6 w-44 max-w-full bg-slate-200 dark:bg-white/10 rounded-lg shimmer" />
      ...
      {/* History Skeleton */}
      <div className="bg-white dark:bg-[#111113] border border-slate-200 dark:border-white/10 rounded-3xl shadow-sm p-4 sm:p-6 space-y-4">
        <div className="h-6 w-52 max-w-full bg-slate-200 dark:bg-white/10 rounded-lg shimmer" />
        <div className="space-y-2">
